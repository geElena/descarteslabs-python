...
metadata_parser.add_argument('command', choices=['sources', 'summary', 'search', 'keys', 'get'],
...
notification_parser.add_argument('command', choices=['identify', 'upload', 'file', 'shape', 'update', 'delete'],
                                 help='The action to take')
...
places_parser.add_argument('-placetype', default=None, help='The placetype of the response')
places_parser.add_argument('-geom', default='low',
